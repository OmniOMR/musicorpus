...
def execute(parser: argparse.ArgumentParser, args: argparse.Namespace):
    ...
    if extend_splits_path is not None:
        existing_splits = Splits.read_from_file(extend_splits_path, run_assertions=True)
        if book_consistent:
    ...
    # read metadata
    page_metadatas = load_page_metadatas(metadata_file_path=metadata_file_path, dpi_file=None)
